package tests.userTest.loginTest;
...
import pageObjects.userPageObjects.loginObjects.LoginPageObject;
...
public class LoginTest extends BaseTest{
	...
	public WebDriver validateUserLogin() throws IOException, InterruptedException {
		driver=initializeDriver();
		LoginPageObject loginpg=new LoginPageObject(driver);
		//LoginPageObject loginpg=new pageObjects.userPageObjects.loginObjects.LoginPageObject(driver); 
		prop=getProperties();
