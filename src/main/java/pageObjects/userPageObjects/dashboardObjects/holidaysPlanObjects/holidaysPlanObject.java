package pageObjects.userPageObjects.dashboardObjects.holidaysPlanObjects;
...
WebDriver driver;
	...
	@FindBy(xpath="//span[contains(text(),'Holiday Plan')]")
	WebElement holidayPlanText;
	...
	public String getHolidayPlanText() {
		return holidayPlanText.getText();
	}
	
	
	public WebElement getClickOnReqHoliday() {
